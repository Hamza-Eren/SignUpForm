...
gender_frame.place(x=20, y=70, width=260, height=50)
var = StringVar()
...
name_frame.place(x=20, y=130, width=260, height=40)
...
age_frame.place(x=20, y=180, width=260, height=50)
...
btn.place(x=30, y=250, width=240, height=30)
